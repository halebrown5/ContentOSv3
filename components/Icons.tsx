...
export const IconMagic = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m5 8 4 4"/><path d="M4 14.5c.39-3 3.5-6 7-6 1.41 0 2.5 1.5 4.5 3 .5.38 2.5 1 2.5 1s-1.5-2.5-3-3.5c-1.5-1-1.5-3.5-2.5-4C10.5 4 8 3.5 5 7c-2 2.5-2 5.5-1 7.5Z"/></svg>
);
